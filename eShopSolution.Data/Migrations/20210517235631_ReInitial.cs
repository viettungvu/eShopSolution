    ...
    public partial class ReInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a18be9c0-aa65-4af8-bd17-00bd9344e575"), "d33190c8-94f9-4acc-985f-d65577cd3f9f", null, "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a18be9c0-aa65-4af8-bd17-00bd9344e575"), 0, "50212911-f616-4a2e-a1d4-da4413496a49", new DateTime(2021, 5, 18, 0, 0, 0, 0, DateTimeKind.Local), "vi-Viettungtvhd@gmail.com", true, "Vu vi-Viet", "Tung", false, null, "vi-Viettungtvhd@gmail.com", "admin", "AQAAAAEAACcQAAAAEOsIVtA3gzMxXXMaHl4cVb8kpLFQxlVSvWUU63GrEi7BfJo5hCLPJgbAG7YLpMixig==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 5, 18, 6, 56, 30, 515, DateTimeKind.Local).AddTicks(698), 100000m, 200000m },
                    { 2, new DateTime(2021, 5, 18, 6, 56, 30, 516, DateTimeKind.Local).AddTicks(8276), 100000m, 200000m },
                    { 3, new DateTime(2021, 5, 18, 6, 56, 30, 516, DateTimeKind.Local).AddTicks(8350), 100000m, 200000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-Vi", "Danh mục 1", "Danh mục 1", "Danh mục 1", "Danh mục 1" },
                    { 3, 2, "vi-Vi", "Danh mục 2", "Danh mục 2", "Danh mục 2", "Danh mục 2" },
                    { 5, 3, "vi-Vi", "Danh mục 3", "Danh mục 3", "Danh mục 2", "Danh mục 3" },
                    { 7, 4, "vi-Vi", "Danh mục 4", "Danh mục 4", "Danh mục 4", "Danh mục 4" },
                    { 2, 1, "en-US", "Category 1", "Category 1", "Category 1", "Category 1" },
                    { 4, 2, "en-US", "Category 2", "Category 2", "Category 2", "Category 2" },
                    { 6, 4, "en-US", "Category 3", "Category 3", "Category 3", "Category 3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "Product 2", "Product 2", "en-US", "Product 2", 2, "product-2", "Product 2", "Product 2" },
                    { 1, "San pham 1", "San pham 1", "vi-Vi", "Sản phẩm 1", 1, "san-pham-1", "San pham 1", "San pham 1" },
                    { 2, "Product 1", "Product 1", "en-US", "Product 1", 1, "product-1", "Product 1", "Product 1" },
                    { 5, "San pham 3", "San pham 3", "vi-Vi", "Sản phẩm 3", 3, "san-pham-3", "San pham 3", "San pham 3" },
                    { 3, "San pham 2", "San pham 2", "vi-Vi", "Sản phẩm 2", 2, "san-pham-2", "San pham 2", "San pham 2" },
                    { 6, "Product 3", "Product 3", "en-US", "Product 3", 3, "product-3", "Product 3", "Product 3" }
                });
